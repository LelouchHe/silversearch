...
| -------- | ---------- | ------- |
| Chinese | [jieba-wasm](https://github.com/fengkx/jieba-wasm) | `config.set("silversearch.enableChinese", true)` |

You can install this by using [Library Manager](https://silverbullet.md/Library%20Manager). Just click "Install from URI", and enter `ghr:LelouchHe/silversearch@multilingual/PLUG.md`, which will install the latest version from [`multilingual-support`](https://github.com/LelouchHe/silversearch/tree/multilingual-support) branch
